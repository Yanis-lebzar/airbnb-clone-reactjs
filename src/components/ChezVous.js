...
import "../style/ChezVous.css";
import ChezVousCard from "./ChezVousCard";
function ChezVous() {
  return (
    <div className='chezVous__container'>
      <h1>Chez vous, partout</h1>
      <div className='chezVous__cards'>
        <ChezVousCard
          url='https://a0.muscache.com/im/pictures/2f13349d-879d-43c6-83e3-8e5679291d53.jpg?im_w=480'
          text='Escapades en pleine nature'
        />
        <ChezVousCard
